...
<h1 >Registro Placas</h1>
<br>
<form align="center-justify">
  <div class="form-group">
    <label>Placas</label>
    <font color="black">
    <input class="input-lg" id="placas" name="placas" align="right">
    </font>
    <br><br>
    <button type="button" class="btn btn-primary glyphicon glyphicon-ok-circle btn btn-default" id="val"> VALIDAR</button>
  </div>
  <div class="form-group">
    <label>Fecha:</label>   
<font color="black">
